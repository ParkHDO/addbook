...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()        
        loadUi('C:/hdh2024/myPrj02/res/ui01.ui', self)
        ...
        self.default_pixmap = QPixmap('C:\\hdh2024\\myPrj02\\res\\a.png')  # 디폴트 이미지 경로        
    ...
    def add_address_book_from_database(self):
        ...
        # 데이터베이스에서 모든 데이터를 가져온다.
        result = self.db.getAllData()
        for row in result:
            name = row['name']
            phone = row['phone']
    ...
    def load_address_book(self):                                
        filename = 'c:/hdh2024/myPrj02/addbook2.txt'        
        if filename:
